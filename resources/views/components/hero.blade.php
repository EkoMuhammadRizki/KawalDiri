            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-5 text-center text-lg-start">
                    ...
                    <h1 class="display-3 font-black lh-1 mb-4">
                        Atur Hidup. <br>
                        <span class="text-primary">Kejar Mimpi.</span>
                    </h1>
                    <p class="lead text-muted mb-5">
                        Solusi All-in-One untuk anak muda ambisius. Kelola waktu produktif dan finansial dalam satu flow yang seamless. Fokus pada tujuan, kami yang rapikan jalannya.
                    </p>
                    ...
                    <div class="mockup-container animate-float">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                <div class="card-stat bg-light">
                                    ...
                                    <h2 class="fw-black mb-0">Rp 450k</h2>
                                </div>
                            </div>
                        </div>
                        <div class="mt-4 p-4 border rounded-4 bg-white shadow-sm">
                            ...
                            <div class="progress" style="height: 40px; border-radius: 12px;">
                                <div class="progress-bar bg-primary" style="width: 70%">Produktivitas</div>
                                <div class="progress-bar bg-success" style="width: 30%">Finansial</div>
                            </div>
                        </div>
                    </div>
                </div>
